...
variable "cluster_name" {
  ...
  default = "mgramseva-prod" #REPLACE
}
...
variable "db_name" {
  ...
  default = "mgramseva_prod" #REPLACE
}

variable "db_username" {
  description = "RDS database user name"
  default = "mgramsevaprod" #REPLACE
}

variable "iam_user_arn" {
  description = "Provide the IAM user arn which you are using to create infrastructure"
  default = "arn:aws:iam::197939965038:user/MGram_app_User" #Example: arn:aws:iam::4332145635273:user/demo
}
