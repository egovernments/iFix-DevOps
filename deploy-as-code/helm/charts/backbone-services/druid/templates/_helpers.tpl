...
{{ template "druid.name" . }}-{{ .Values.historical.name }}
{{- end -}}
...
{{ template "druid.name" . }}-{{ .Values.middleManager.name }}
{{- end -}}
...
{{ template "druid.name" . }}-{{ .Values.broker.name }}
{{- end -}}
...
{{ template "druid.name" . }}-{{ .Values.overlord.name }}
{{- end -}}
...
{{ template "druid.name" . }}-{{ .Values.coordinator.name }}
{{- end -}}
...
{{ template "druid.name" . }}-{{ .Values.router.name }}
{{- end -}}
